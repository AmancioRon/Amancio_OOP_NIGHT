 ...
 */
package amancio.simplecalculator;
...
public class SimpleCalculator extends javax.swing.JFrame {
 ...
 public void enable()
    ...
    private void initComponents() {
        ...
        jButton22.setForeground(new java.awt.Color(51, 204, 0));
        jButton22.setText("•");
        ...
        jButton23.setForeground(new java.awt.Color(51, 204, 0));
        jButton23.setText("=");
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        int shesh = jTextField1.getText().length();
        int basta = jTextField1.getText().length() - 1;
        String synapse;
        
        if(shesh > 0)
        {
            StringBuilder likod = new StringBuilder(jTextField1.getText());
            likod.deleteCharAt(basta);
            synapse = likod.toString();
            jTextField1.setText(synapse);
        }
